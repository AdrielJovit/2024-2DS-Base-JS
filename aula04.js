...
imprimeTexto('Sou aluno de desenvolvimento de sistemas')
...
imprimeTexto(apresentacao('Adriel', 16))
imprimeTexto(apresentacao(16, 'Adriel')) // A ordem dos parâmetros é importante
